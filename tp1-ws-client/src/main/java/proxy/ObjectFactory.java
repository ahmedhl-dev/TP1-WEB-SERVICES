...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDh_QNAME = new QName("http://tp.com/", "ConversionEuroToDh");
    private static final QName _ConversionEuroToDhResponse_QNAME = new QName("http://tp.com/", "ConversionEuroToDhResponse");
    private static final QName _GetAccount_QNAME = new QName("http://tp.com/", "getAccount");
    private static final QName _GetAccountResponse_QNAME = new QName("http://tp.com/", "getAccountResponse");
    private static final QName _GetAccounts_QNAME = new QName("http://tp.com/", "getAccounts");
    private static final QName _GetAccountsResponse_QNAME = new QName("http://tp.com/", "getAccountsResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "ConversionEuroToDh")
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "ConversionEuroToDhResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "getAccount")
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "getAccountResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "getAccounts")
     ...
     */
    @XmlElementDecl(namespace = "http://tp.com/", name = "getAccountsResponse")
