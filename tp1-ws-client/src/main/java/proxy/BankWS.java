 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://tp.com/", wsdlLocation = "http://localhost:8888/?wsdl")
public class BankWS
    extends Service
{
    ...
    private static final QName BANKWS_QNAME = new QName("http://tp.com/", "BankWS");
    ...
    public BankAccountService getBankAccountServicePort() {
        return super.getPort(new QName("http://tp.com/", "BankAccountServicePort"), BankAccountService.class);
    }
    ...
    public BankAccountService getBankAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp.com/", "BankAccountServicePort"), BankAccountService.class, features);
    }
